...
def collatz_eval(n):
    ...
    if n < 5000000:
        metacache = [1, 2, 3, 6, 7, 9, 18, 19, 25, 27, 54, 55, 73, 97, 129, 171, 231, 235, 313, 327, 649, 654, 655, 667, 703, 871, 1161, 2223, 2322, 2323, 2463, 2919, 3711, 6171, 10971, 13255, 17647, 17673,
...
def collatz_meta(n):
    """
    I used this to make meta cache
    pretty cool huh?
    """
    q = 1
    p = 1
